...
class UlpoadeImageCoverUsecase {
  final SettingRepo _repo;

  UlpoadeImageCoverUsecase({required SettingRepo repo}) : _repo = repo;

  Future<Either<FialureServer, String>> call(
      {required String userId,
      required File file,
      required String path}) async {
    return await _repo.ulpoadeCoverImage(userId: userId, file: file, path: path);
  }
}